...
if __name__ == "__main__":
    ...
    prompts = [
        ...
        "An (((octcat in the style of <octocat> with cat head and octopus body))), 2d character design, vector art, digital art, portrait, 4 k, 8 k, sharp focus, smooth, illustration, concept art",
        ...
        "GitHub Octocat in the style of (((<octocat> with a cat head and octopus tentacles))), dynamic comic hero pose, aesthetic, captivating, (((concept art, anime, hyper-detailed and intricate, fine detail, colorful, realistic proportions, symmetrical, sharp focus, 8K resolution)))"
        ...
        "portrait of an astronaut (((GitHub octocat in the style of <octocat> with cat head and octopus legs))), by Andy Warhol",
    ]
